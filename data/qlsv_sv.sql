...
CREATE TABLE `sv` (
  ...
  `CMND` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `lop_MaLop` varchar(7) NOT NULL,
  PRIMARY KEY (`MSSV`),
  UNIQUE KEY `MSSV_UNIQUE` (`MSSV`),
  KEY `fk_sv_lop_idx` (`lop_MaLop`),
  CONSTRAINT `fk_sv_lop` FOREIGN KEY (`lop_MaLop`) REFERENCES `lop` (`MaLop`)
...
-- Dump completed on 2020-06-20 16:28:31
